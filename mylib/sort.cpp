...
template<typename I>
void my::insertsort( I low, I high ){
...
template<typename I>
void my::quickinsertsort( I low, I high ){
	if (low < high-1) {
...
template<typename I>
void my::quicksort( I low, I high ){
	if (low < high) {
...
template<typename I>
void my::doublepivotquicksort( I low, I high ){
	if (low < high-1) {
	auto lp = low + std::distance(low, high-1)/3;
	auto rp = high-1 - std::distance(low, high-1)/3;
	std::swap(*low, *lp );
